...
// Addded to wpresiddence-child-po July 20, 2020
// Updated to accomodate alphbetical rendering of agent titles for CPT 'estate_agent'
  ...
  <div class="row">
    ...
    <div class=" <?php print esc_html($wpestate_options['content_class']);?> ">
      ...
      <div id="listing_ajax_container_agent">
        <?php
        // Updated to render agents in alphbetical order
        $args = array(
          'cache_results'     => false,
          'post_type'         => 'estate_agent',
          'paged'             => $paged,
          'posts_per_page'    => 12,
          'orderby'           => 'title', // Assigns alphbetical order
          'order'             => 'ASC'); // Ascending order alphbetically
