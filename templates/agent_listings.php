...
// WP Kraken #x821271: Change terms to action category
$terms = get_terms( 'property_action_category', array(
	'hide_empty' => false,
	'slug' => 'sold' // remove this line to show more action categories
) );
...
$term_bar='<div class="term_bar_item active_term" data-term_id="0" data-term_name="all">'.esc_html__('For Sale','wpresidence').' ('.esc_html($prop_selection->found_posts).')</div>'; // WP Kraken #x821271: Change All to For Sale
