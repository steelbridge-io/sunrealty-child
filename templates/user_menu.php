...
<div class="user_tab_menu">
    ...
    <div class="user_dashboard_links">
        ...
        if( $dash_link!=$home_url && $dash_link!=''){
            ...
            <a href="https://sunrealty-florida.com/forms" class="<?php print $activedash; ?>"> <i class="fa fa-map-marker"></i> <?php _e('Forms','wpestate');?></a>
        <?php } 
        }?>
		<?php 
        if( $dash_link!=$home_url && $dash_link!=''){
            if($user_agent_id==0 || ( $user_agent_id!=0 && get_post_status($user_agent_id)!='pending' && get_post_status($user_agent_id)!='disabled') ){?>
            <a href="https://sunrealty-florida.com/marketing" class="<?php print $activedash; ?>"> <i class="fa fa-map-marker"></i> <?php _e('Marketing','wpestate');?></a>
        <?php } 
        }?>
