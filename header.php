...
if ( $favicon!='' ){
    ...
    print '<link rel="shortcut icon" href="'.get_template_directory_uri().'/img/favicon.gif" type="image/x-icon" />';
}
...
$show_submit_symbol    =   esc_html ( get_option('wp_estate_show_submit','') );
...
<div class="container main_wrapper <?php print esc_html($wide_class); print esc_html('has_header_'.$logo_header_type.' '.$header_transparent_class); print  'contentheader_'.$logo_header_align; print ' cheader_'.$logo_header_align;?> ">
    ...
    <div class="master_header <?php print esc_html($wide_class.' '.$header_transparent_class); print ' '.$wide_header_class;?>">
        ...
        <div class="header_wrapper <?php print $show_top_bar_user_login_class.' header_'.$logo_header_type.' header_'.$logo_header_align; print ' hover_type_'.$top_menu_hover_type.' header_alignment_text_'.$text_header_align_select; print $show_submit_symbol_class;?> ">
            <?php
            ...
            <div class="header_wrapper_inside <?php print $wide_header_class; ?>" data-logo="<?php print $logo;?>" data-sticky-logo="<?php print $stikcy_logo_image; ?>">
